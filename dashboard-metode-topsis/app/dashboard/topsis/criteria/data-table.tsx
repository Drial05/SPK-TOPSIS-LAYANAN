...
export function DataTable<TData, TValue>({
  ...
  const [modalBeneft, setModalBenefit] = React.useState(false);
  const [modalCost, setModalCost] = React.useState(false);
  ...
  return (
    <div className="rounded-md border px-4">
      <div className="flex items-center py-4 gap-4">
        ...
        >
          <AccordionItem value="item-1">
            ...
            <AccordionContent className="flex flex-col gap-4 text-balance">
              <p>
                Benefit adalah kriteria keuntungan dalam pengambilan keputusan,
                yaitu kriteria yang semakin tinggi nilainya maka semakin baik
                hasilnya.
              </p>
            </AccordionContent>
          </AccordionItem>
          <AccordionItem value="item-2">
            ...
            <AccordionContent className="flex flex-col gap-4 text-balance">
              <p>
                Cost adalah kriteria biaya dalam pengambilan keputusan, yaitu
                kriteria yang semakin rendah nilainya maka semakin baik hasilnya
              </p>
            </AccordionContent>
          </AccordionItem>
        </Accordion> */}

        <Dialog open={modalBeneft} onOpenChange={setModalBenefit}>
        ...
        <Dialog open={modalCost} onOpenChange={setModalCost}>
          <DialogTrigger asChild>
            <Button variant="outline" className="">
              Cost
            </Button>
