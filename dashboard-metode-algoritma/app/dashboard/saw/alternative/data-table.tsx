  ...
  const handleImport = async () => {
    ...
    try {
      const res = await fetch(
        "http://localhost:3000/api/saw/alternative/import",
        {
          method: "POST",
          headers: {
      ...
      <div className="flex items-center py-4 gap-4">
        ...
        <Dialog open={openImport} onOpenChange={setOpenImport}>
          ...
          <DialogContent className="md:max-w-[600px] sm:max-w-[400px]">
            <DialogHeader>
              <DialogTitle>Import Alternatives</DialogTitle>
              <DialogDescription>
                Import file data alternatives is here, click button save if
                done.
              </DialogDescription>
            </DialogHeader>
          ...
          <DialogContent className="md:max-w-[600px] sm:max-w-[400px]">
            <form action={handleSubmit}>
              <DialogHeader>
                ...
                <DialogDescription>
                  You can add candidate is here. clicl save to save your
                  candidate.
                </DialogDescription>
              </DialogHeader>
              <div className="grid gap-4 mb-4 sm:mb-5">
