...
exports.removeCriteria = exports.editCriteria = exports.addCriteria = exports.getPagenitionCriteria = exports.getCriteria = void 0;
...
const getCriteria = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const [data] = yield (0, criteriaModel_1.getAllCriteria)();
        res.json({
            data,
        });
    }
...
const getPagenitionCriteria = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const page = parseInt(req.query.page, 10) || 1;
    const pageSize = parseInt(req.query.pageSize, 10) || 10;
    const offset = (page - 1) * pageSize;
    try {
        const { data, totalRows, totalPages } = yield (0, criteriaModel_1.getPageCriteria)(pageSize, offset);
        res.json({
            data,
            page,
            pageSize,
...
exports.getPagenitionCriteria = getPagenitionCriteria;
const addCriteria = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { name, weight, attribute } = req.body;
    try {
        const result = yield (0, criteriaModel_1.createCreate)(name, weight, attribute);
...
const editCriteria = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const { name, weight, attribute } = req.body;
    try {
        const result = yield (0, criteriaModel_1.updateCriteria)(parseInt(id), name, weight, attribute);
